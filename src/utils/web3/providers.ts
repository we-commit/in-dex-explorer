...
const { INFURA_KEY1, INFURA_KEY2, INFURA_KEY3, INFURA_KEY4, ALCHEMY_KEY1, ALCHEMY_KEY2, ETHERSCAN_KEY1, ETHERSCAN_KEY2, POKT_KEY, GET_BLOCK_KEY, MAIN_WS } =
  KEYS;
...
export { providersForLM, providersForLC, mainWsComm, escan1, escan2, MAIN_WS_PROVIDER };
