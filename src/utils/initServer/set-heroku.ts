...
exec('heroku config:set INFURA_KEY4="' + process.env.INFURA_KEY4 + '" -a ' + process.env.HEROKU_APP_NAME, callbackpew);
exec('heroku config:set ALCHEMY_KEY1="' + process.env.ALCHEMY_KEY1 + '" -a ' + process.env.HEROKU_APP_NAME, callbackpew);
exec('heroku config:set ALCHEMY_KEY2="' + process.env.ALCHEMY_KEY2 + '" -a ' + process.env.HEROKU_APP_NAME, callbackpew);
exec('heroku config:set ETHERSCAN_KEY1="' + process.env.ETHERSCAN_KEY1 + '" -a ' + process.env.HEROKU_APP_NAME, callbackpew);
exec('heroku config:set ETHERSCAN_KEY2="' + process.env.ETHERSCAN_KEY2 + '" -a ' + process.env.HEROKU_APP_NAME, callbackpew);
exec('heroku config:set POKT_KEY="' + process.env.POKT_KEY + '" -a ' + process.env.HEROKU_APP_NAME, callbackpew);
exec('heroku config:set GET_BLOCK_KEY="' + process.env.GET_BLOCK_KEY + '" -a ' + process.env.HEROKU_APP_NAME, callbackpew);
